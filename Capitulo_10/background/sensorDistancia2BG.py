...
def create_figure_D2(x_data, y_data):
    return {
        'data': [
            go.Scatter(
                x=x_data,
...
sensorDistancia2 = dbc.Container([
    ...
    dcc.Graph(id="sensorDistancia2", figure=create_figure_D2([], [])),
    dcc.Interval(id='interval-sensorDistancia2', interval=2000, n_intervals=0),
])

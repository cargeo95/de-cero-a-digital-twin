...
def create_figure_V1(x_data, y_data):
    return {
        'data': [
            go.Scatter(
                x=x_data,
...
sensorDistancia1 = dbc.Container([
    ...
    dcc.Graph(id="sensorVibracion1", figure=create_figure_V1([], [])),
    dcc.Interval(id='interval-sensorVibracion1', interval=2000, n_intervals=0),
])

...
def create_figure_V3(x_data, y_data):
    return {
        'data': [
            go.Scatter(
                x=x_data,
...
sensorDistancia1 = dbc.Container([
    ...
    dcc.Graph(id="sensorVibracion3", figure=create_figure_V3([], [])),
    dcc.Interval(id='interval-sensorVibracion3', interval=2000, n_intervals=0),
])
